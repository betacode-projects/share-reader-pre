const HOST_URL = 'http://192.168.137.1/share-reader-api';

const RECIEVER_TOKEN_PAGE = HOST_URL + '/set_reciever.php';
const UPLOAD_PAGE = HOST_URL + '/upload_file.php';
const CHECK_SENDER_PAGE = HOST_URL + '/check_sender.php';
const CHECK_RECIEVER_PAGE = HOST_URL + '/check_reciever.php';
